 ...
 * @license http://www.kumbia.org/license.txt GNU/GPL
 */
abstract class InteractiveBuilder extends Object {
	...
	static function create_model($model, $controller, $action){
		...
		".button_to_action("Si", "$application/builder/create_model/$model/$controller/$action")."<input type='button' value='No' onclick='$(this.parentNode).hide()'/>");
	}
