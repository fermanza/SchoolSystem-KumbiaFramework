...
//					if ( $alumno -> miReg == $registro ){
		...
		function ficha($NumConcepto=100, $registro = 830001, $materia_id= 0, $horario_id = 0){
         ...
         $referenciaCompleta = $referencia1.$digitoVerif;		
		  ...
		  $xIntersemestral	= new IntersemestralCursos();
		  //Se obtiene el nombre de la materia 
		 
		  IF($NumConcepto == 95 || $NumConcepto == 94){
	        		  $nombreMateria = $xIntersemestral->find_all_by_sql("SELECT ia.registro, m.nombre as materia, ic.periodo, ic.id 
														...
														WHERE ia.registro = '".$registro."' AND  ic.id = '".$horario_id."'
