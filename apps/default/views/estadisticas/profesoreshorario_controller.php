    ...
    class profesoreshorarioController extends ApplicationController {
        ...
        function index(){
       	...
       	function horarioPorDivision(){
			...
			// Índicies de reprobación. Curso, horas clase por curso,o 
			//numero de alumnos, cuántos alumnos con np, alumnos reprobados,
			...
			//que el usuario que está intentando ver
